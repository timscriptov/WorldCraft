...
public class Tesselator {
    @NonNull
    @Contract("_ -> new")
    public static Shape tesselate(@NonNull float... verts) {
    ...
    @Contract(pure = true)
    private static short next(@NonNull boolean[] used, short index) {
        do {
    ...
    private static boolean contains(@NonNull Vector3f a, @NonNull Vector3f b, Vector3f c, @NonNull Vector3f p) {
    ...
    @Contract(pure = true)
    private static boolean isConcave(@NonNull Vector3f p, @NonNull Vector3f c, @NonNull Vector3f n) {
    ...
    @NonNull
    @Contract(pure = true)
    private static Vector3f[] buildCounterList(@NonNull Vector3f[] v) {
    ...
    @Contract(pure = true)
    private static boolean traverseOrder(@NonNull Vector3f[] v) {
