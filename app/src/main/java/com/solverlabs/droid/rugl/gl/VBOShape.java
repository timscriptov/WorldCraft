...
public class VBOShape {
    ...
    public VBOShape(@NonNull TexturedShape ts) {
        this.state = ts.state;
        ...
        for (int i = 0; i < this.vertexCount; i++) {
            ...
            this.dataBuffer.putFloat(ts.texCoords[(i * 2) + 0]);
            this.dataBuffer.putFloat(ts.texCoords[(i * 2) + 1]);
        }
    ...
    public VBOShape(@NonNull ColouredShape cs) {
        this.state = cs.state;
