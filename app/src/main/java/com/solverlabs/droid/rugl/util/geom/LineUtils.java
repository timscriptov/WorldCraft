...
public class LineUtils {
    ...
    public static Vector2f lineIntersection(ReadableVector2f p0, ReadableVector2f p1, ReadableVector2f p2, ReadableVector2f p3, Vector2f result) {
    ...
    public static Vector2f[] segmentCircleIntersection(Vector2f l1, Vector2f l2, Vector2f p, float cr) {
        float dx = l2.x - l1.x;
        float dy = l2.y - l1.y;
        float a = (dx * dx) + (dy * dy);
        float b = 2.0f * (((l1.x - p.x) * dx) + ((l1.y - p.y) * dy));
