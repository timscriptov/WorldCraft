...
public class PerlinSimplexNoise {
    ...
    @Contract(pure = true)
    private static float dot(@NonNull int[] g, float x, float y) {
        return (g[0] * x) + (g[1] * y);
    }

    @Contract(pure = true)
    private static float dot(@NonNull int[] g, float x, float y, float z) {
        return (g[0] * x) + (g[1] * y) + (g[2] * z);
    }

    @Contract(pure = true)
    private static float dot(@NonNull int[] g, float x, float y, float z, float w) {
