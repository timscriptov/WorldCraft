...
public class ShapeUtil {
    static final boolean assertionsDisabled = !ShapeUtil.class.desiredAssertionStatus();
    ...
    @NonNull
    @Contract(pure = true)
    public static float[] to3D(@NonNull float[] verts, float z) {
    ...
    @NonNull
    @Contract(pure = true)
    public static float[] to2D(@NonNull float[] verts) {
    ...
    static void addTriangle(short a, short b, short c, @NonNull short[] array, int index) {
        array[index] = a;
        array[index + 1] = b;
        array[index + 2] = c;
    }
    ...
    @Contract("_ -> param1")
    public static float[] vertFlipQuadTexCoords(@NonNull float[] tc) {
    ...
    @NonNull
    @Contract(pure = true)
    public static float[] extract(@NonNull Vector3f[] verts) {
    ...
    @NonNull
    @Contract(pure = true)
    public static float[] extract(@NonNull Vector2f[] verts, float z) {
        float[] v = new float[verts.length * 3];
        for (int i = 0; i < verts.length; i++) {
            v[i * 3] = verts[i].x;
            v[(i * 3) + 1] = verts[i].y;
    ...
    @NonNull
    @Contract(pure = true)
    public static float[] extract(@NonNull Vector2f[] verts) {
    ...
    @NonNull
    @Contract(pure = true)
    public static float[] extract(@NonNull List<Vector3f> verts) {
    ...
    @NonNull
    @Contract(pure = true)
    public static float[] extractVerts(@NonNull List<Vector2f> verts, float z) {
        float[] va = new float[verts.size() * 3];
        int vi = 0;
    ...
    @NonNull
    public static short[] extractIndices(@NonNull List<Short> indexes) {
