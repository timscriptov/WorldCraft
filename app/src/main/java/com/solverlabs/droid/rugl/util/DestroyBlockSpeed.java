...
public class DestroyBlockSpeed {
    ...
    private static class SpeedItem {
        ...
        public SpeedItem(byte blockType, byte weaponType) {
            this.blockType = Byte.valueOf(blockType);
            this.weaponType = Byte.valueOf(weaponType);
        }
        ...
        public boolean equals(Object o) {
            ...
            return ((SpeedItem) o).blockType == this.blockType && ((SpeedItem) o).weaponType == this.weaponType;
        }
