        ...
        if (this.currentValue != value) {
            ...
            for (int i2 = 0; i2 < this.intDigits; i2++) {
                ...
                if (i2 == 0 && this.intDigits > 1 && digit == 0) {
                    System.arraycopy(this.digitTexCoords[10], 0, this.texCoords, index, 8);
                } else {
                    System.arraycopy(this.digitTexCoords[digit], 0, this.texCoords, index, 8);
                }
                index += 8;
            }
            int index2 = index + 8;
            for (int i3 = 0; i3 < this.fracDigits; i3++) {
                ...
                System.arraycopy(this.digitTexCoords[digit2], 0, this.texCoords, index2, 8);
                index2 += 8;
            }
        }
    }
