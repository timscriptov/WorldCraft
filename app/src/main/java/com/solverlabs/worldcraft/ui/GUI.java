        ...
        this.touchListener = new Touch.TouchListener() {
            ...
            public void pointerRemoved(Touch.Pointer p) {
                for (int i = 0; i < widgets.size(); i++) {
                    ((Touch.TouchListener) widgets.get(i)).pointerRemoved(p);
                    p.isUse = false;
                }
            }
            ...
            public boolean pointerAdded(Touch.Pointer p) {
                ...
                for (int i = 0; i < widgets.size() && !eaten; i++) {
                    eaten = ((Touch.TouchListener) widgets.get(i)).pointerAdded(p);
                }
                return false;
            }
            ...
            public void reset() {
                for (int i = 0; i < widgets.size(); i++) {
                    ((Touch.TouchListener) widgets.get(i)).reset();
                }
            }
        };
    }
