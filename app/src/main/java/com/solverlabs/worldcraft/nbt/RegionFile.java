 ...
 * notice above). It has been slightly modified by Mojang AB (constants instead
 * of magic numbers, a chunk timestamp header, and auto-formatted according to
 * our formatter template).
 */
