...
public class Entity {
    ...
    private void parseRotation(Tag tag) {
        ...
        this.yaw = ((Float) rotation[0].getValue()).floatValue();
        this.pitch = ((Float) rotation[1].getValue()).floatValue();
    }
    ...
    private void updateRotationTag() {
        ...
        rotationTag[0].setValue(Float.valueOf(this.yaw));
        rotationTag[1].setValue(Float.valueOf(this.pitch));
    }
    ...
    private void updateMotionTag() {
        ...
        motionTag[0].setValue(Float.valueOf(this.motion.x));
        motionTag[1].setValue(Float.valueOf(this.motion.y));
        motionTag[2].setValue(Float.valueOf(this.motion.z));
    }
    ...
    private void updatePositionTag() {
        ...
        positionTag[0].setValue(Float.valueOf(this.position.x));
        positionTag[1].setValue(Float.valueOf(this.position.y));
        positionTag[2].setValue(Float.valueOf(this.position.z));
    }
    ...
    private Tag serializeRotation() {
        ...
        rotationList.addTag(new Tag(Tag.Type.TAG_Float, DescriptionFactory.emptyText, Float.valueOf(this.yaw)));
        rotationList.addTag(new Tag(Tag.Type.TAG_Float, DescriptionFactory.emptyText, Float.valueOf(this.pitch)));
        return rotationList;
    }

    private Tag serializeMotion() {
        Tag motionList = new Tag(MOTION, Tag.Type.TAG_Double);
        motionList.addTag(new Tag(Tag.Type.TAG_Double, DescriptionFactory.emptyText, Double.valueOf(this.motion.x)));
        motionList.addTag(new Tag(Tag.Type.TAG_Double, DescriptionFactory.emptyText, Double.valueOf(this.motion.y)));
        motionList.addTag(new Tag(Tag.Type.TAG_Double, DescriptionFactory.emptyText, Double.valueOf(this.motion.z)));
        return motionList;
    }

    private Tag serializePosition() {
        Tag positionList = new Tag(POS, Tag.Type.TAG_Double);
        positionList.addTag(new Tag(Tag.Type.TAG_Double, DescriptionFactory.emptyText, Double.valueOf(this.position.x)));
        positionList.addTag(new Tag(Tag.Type.TAG_Double, DescriptionFactory.emptyText, Double.valueOf(this.position.y)));
        positionList.addTag(new Tag(Tag.Type.TAG_Double, DescriptionFactory.emptyText, Double.valueOf(this.position.z)));
        return positionList;
    }
