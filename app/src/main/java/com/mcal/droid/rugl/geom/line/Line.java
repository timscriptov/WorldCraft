...
public class Line {
    static final boolean assertionsDisabled = !Line.class.desiredAssertionStatus();
    ;
    ...
    public Shape buildLoop(float z) {
        ...
        if (this.points.size() >= 3) {
            ...
            List<Vector2f> v = new LinkedList<>();
            List<Short> i = new LinkedList<>();
            Vector2f first3 = this.points.removeFirst();
    ...
    private void start(Vector2f first, Vector2f second, @NonNull List<Vector2f> verts, List<Short> indices) {
