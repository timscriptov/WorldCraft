...
import com.mcal.droid.rugl.util.geom.MatrixUtils;
...
public class Renderer {
    ...
    public void addGeometry(@NonNull float[] verts, float[] textureCoordinates, int[] vertexColours, short[] geomIndices, State state) {
    ...
    public void addGeometry(@NonNull int[] verts, int[] textureCoordinates, int[] vertexColours, short[] geomIndices, State state) {
        int vc = verts.length / 3;
        if (state == null) {
            state = GLUtil.typicalState;
        }
    ...
    public static class IndexList {
        ...
        public void add(@NonNull short[] ti, int indexOffset) {
