...
import com.mcal.worldcraft.mob.cow.CowFactory;
import com.mcal.worldcraft.mob.pig.Pig;
import com.mcal.worldcraft.mob.pig.PigFactory;
...
public class MobPainter {
    ...
    public static void loadTexture(World world) {
        ...
        cowFactory.loadTexture("cow.png");
        pigFactory.loadTexture("pig.png");
        sheepFactory.loadTexture("sheep.png");
        zombieFactory.loadTexture("zombie.png");
